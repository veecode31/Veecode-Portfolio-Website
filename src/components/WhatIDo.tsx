        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building robust, scalable, and secure server-side applications and REST APIs using modern Python frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Automating repetitive tasks, scraping web data, and integrating third-party APIs to streamline workflows.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Selenium</div>
                <div className="what-tags">BeautifulSoup</div>
                <div className="what-tags">Requests</div>
                <div className="what-tags">Web Automation</div>
